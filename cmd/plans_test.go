...
`
	...
	wantJSONL := `{"month":"2026-09","ready_to_assign":-500.00,"overspent_count":1,"overspent_total":-25.00,"underfunded_count":0,"underfunded_total":0.00,"unapproved_count":2,"uncategorized_count":2,"import_error_accounts":["Visa"]}` + "\n"
	if jsonl != wantJSONL {
